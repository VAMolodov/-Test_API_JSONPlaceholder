...
from data import POST_SCHEMA, base_url, fake_id, UPDATE_PAYLOADS
...
class TestPostsApi:
    ...
    def test_get_single_post(self, api_session, post_for_del):
    ...
    def test_get_all_post(self, api_session):
    ...
    def test_create_post_success(self, api_session, test_payload_and_delete_post):
    ...
    def test_delete_post_success(self, api_session, post_for_del):
        target_id = post_for_del # Получаем ID из фикстуры
    ...
    def test_delete_fake_post(self, api_session):
    ...
    def test_update_post_put(self, api_session, test_payload_and_delete_post, payload_param):
